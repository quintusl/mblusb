...
uint16_t layout[2][128] = {
	...
	/*Row 5*/KB_LCTRL, KB_LGUI , KB_LALT , KB_A	   , KB_A    , KB_SPACE, KB_A    , KB_A    , KB_A    , KB_RALT , KB_RGUI , MLAYER_1, KB_RCTRL, KB_LEFT , KB_DOWN , KB_RIGHT,
	/*Row 6*/KB_CAPLK, KB_A    , KB_S    , KB_D    , KB_F    , KB_G    , KB_H    , KB_J    , KB_K    , KB_L    , KB_SMCLN, KB_QUOTE, KB_A , KB_ENTER, KB_PGUP , KB_PAUSE,
	/*Row 7*/KB_LSHFT, KB_Z    , KB_X    , KB_C    , KB_V    , KB_B    , KB_N    , KB_M    , KB_COMMA, KB_DOT  , KB_SLASH, KB_A    , KB_RSHFT, KB_A    , KB_PGDN , 255
	},
	{ //Layer 1
	  //      | Col 0  |  Col 1  |  Col 2  |  Col 3  |  Col 4  |  Col 5  |  Col 6  |  Col 7  |  Col 8  |  Col 9  |  Col 10 |  Col 11 |  Col 12 |  Col 13 |  Col 14 |  Col 15 |
		/*Row 0*/2222  , KB_NONE , KB_F1   , KB_F2   , KB_F3   , KB_F4   , KB_F5   , KB_F6   , KB_F7   , KB_F8   , KB_F9   , KB_F10  , KB_F11  , KB_F12  , KB_PSCRN, KB_SCRLK,
	...
	/*Row 6*/KB_LSHFT, KB_Z    , KB_X    , KB_C    , KB_V    , KB_B    , KB_N    , KB_M    , KB_COMMA, KB_DOT  , KB_SLASH, KB_NONE , KB_RSHFT, KB_NONE , KB_PGDN , BR_UP   ,
	/*Row 7*/KB_LCTRL, KB_LGUI , KB_LALT , KB_NONE , KB_NONE , KB_SPACE, KB_NONE , KB_NONE , KB_NONE , KB_RALT , KB_RGUI , MLAYER_1, KB_RCTRL, KB_LEFT , BR_DOWN , 255
	},
};